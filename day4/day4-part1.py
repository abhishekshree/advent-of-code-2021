...
def check_win(checkbox):
    ...
    for x in range(5):
        if (
            checkbox[x][0] == True
            and checkbox[x][1] == True
            and checkbox[x][2] == True
            and checkbox[x][3] == True
            and checkbox[x][4] == True
        ):
            ok = True
    ...
    for y in range(5):
        if (
            checkbox[0][y] == True
            and checkbox[1][y] == True
            and checkbox[2][y] == True
            and checkbox[3][y] == True
            and checkbox[4][y] == True
        ):
            ok = True
